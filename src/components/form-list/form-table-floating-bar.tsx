...
import { FormsGetAllOutput } from "../form-list/form-table-columns";
import { FormsDeleteDialog } from "./form-delete-dialog";

interface FormsTableFloatingBarProps {
  table: Table<FormsGetAllOutput>;
}

export function FormsTableFloatingBar({
  table,
}: FormsTableFloatingBarProps) {
